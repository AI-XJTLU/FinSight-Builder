...
- `screenshots/01_commit_records.png`, `screenshots/02_docker_deployed_website.png`, `screenshots/04_api_health_or_stocks_optional.png`, and `screenshots/05_docker_container_optional.png` have been captured.
- `screenshots/03_github_actions_success.png` must be captured after the local GitHub push/network issue is resolved and the workflow passes on GitHub.
