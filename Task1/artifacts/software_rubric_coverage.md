...
| Coherent professional notebook | Notebook follows a coherent AI-DLC structure: setup, Inception, Construction, Operation, validation. |
| UML diagrams | Notebook writes PlantUML sources and PNG diagram evidence for use case and sequence views. |
| AI-specific tooling | Prompt templates, optional API-key checks, deterministic fallback generation, and human-reviewed outputs are documented. |
